...
export const identificacionOficialOpciones = [
  { value: 'INE', label: 'INE' },
  { value: 'pasaporte', label: 'Pasaporte' },
  { value: 'cartilla militar', label: 'Cartilla Militar' }
];
...
export const distritosPorModulos = {
  'Distrito de Riego 003.Tula': [
    ...
    'Usuarios de Riego del sistema Endho-xochitlan, A.C.',
...
export const cultivosAnuales = ['Maíz', 'Avena para forraje', 'Hortalizas', 'Otros cultivos anuales'];
